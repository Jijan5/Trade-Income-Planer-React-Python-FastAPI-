...
ALLOWED_ORIGINS = os.getenv(
    "ALLOWED_ORIGINS", 
    "http://70.153.19.40:3000,http://70.153.19.40:4000,http://70.153.19.40:5173,http://70.153.19.40:8000,http://localhost:3000,http://localhost:4000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:8000"
).split(",")
