...
const ImageCropModal = ({ file, onApply, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-[#030308]/95 backdrop-blur-md p-4">
      <div className="bg-[#0a0f1c] border border-[#00cfff]/30 p-6 rounded-2xl shadow-[0_0_30px_rgba(0,207,255,0.2)] max-w-lg w-full">
        <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
          <span className="text-[#00cfff]">✂️</span> Crop Avatar
        </h3>
        ...
        {file.type === 'image/gif' ? (
          <div className="text-center py-8">
            ...
            <img src={imageSrc} alt="Preview" className="w-32 h-32 rounded-full object-cover mx-auto border-2 border-[#00cfff]/50 shadow-[0_0_15px_rgba(0,207,255,0.2)]" />
          </div>
        ) : (
          <>
        ...
        <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-[#00cfff]/10">
          ...
          <button
            onClick={handleApply}
            disabled={isProcessing}
            className="bg-[#00cfff] text-[#030308] px-6 py-2 rounded-xl text-sm font-extrabold hover:bg-[#00e5ff] hover:shadow-[0_0_15px_rgba(0,207,255,0.4)] transition-all flex items-center gap-2 disabled:opacity-50"
          >
