...
const SuspendedPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-engine-bg text-white p-4 relative overflow-hidden animate-fade-in">
            {/* Background Effects */}
            ...
            <div className="max-w-2xl w-full bg-engine-panel/90 backdrop-blur-xl rounded-3xl border border-red-500/50 p-10 shadow-[0_0_50px_rgba(239,68,68,0.2)] text-center relative z-10">
                ...
                <div className="bg-engine-bg p-5 rounded-xl border border-red-500/20 text-left mb-6 shadow-[0_0_15px_rgba(239,68,68,0.05)]">
                ...
                <div className="bg-engine-bg p-5 rounded-xl border border-red-500/20 text-left mb-8 shadow-[0_0_15px_rgba(239,68,68,0.05)]">
                ...
                {appealSent ? (
                    ...
                    <div className="bg-engine-bg p-8 rounded-2xl border border-red-500/20 shadow-[0_0_15px_rgba(239,68,68,0.05)] text-left">
                        ...
                        <form onSubmit={handleAppealSubmit}>
                            <textarea
                                ...
                                className="w-full bg-engine-panel border border-red-500/30 rounded-xl p-4 text-white focus:border-red-500 focus:shadow-[0_0_15px_rgba(239,68,68,0.2)] outline-none h-32 resize-none text-sm font-mono placeholder:text-red-500/20 transition-all custom-scrollbar"
                            />
                            {error && <p className="text-red-400 text-xs mt-3 font-extrabold uppercase tracking-widest">{error}</p>}
                            <button type="submit" disabled={loading} className="mt-6 w-full bg-red-500 hover:bg-red-400 text-engine-bg px-6 py-4 rounded-xl font-extrabold uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(239,68,68,0.4)] hover:shadow-[0_0_25px_rgba(239,68,68,0.6)] hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed">
