    ...
    <div className="space-y-8 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          {/* Main Controls Card */}
          <div className="bg-engine-panel p-6 rounded-2xl border border-engine-panel-border/20 shadow-2xl space-y-8">
            <h3 className="text-xs font-extrabold text-engine-neon uppercase tracking-widest border-b border-engine-panel-border/20 pb-3">Journey Parameters</h3>
              ...
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="relative">
                    ...
                    <input 
                      ...
                      className="bg-engine-bg border border-engine-panel-border/30 text-white font-mono font-bold rounded-lg pl-6 pr-3 py-1.5 w-32 text-right focus:border-engine-panel-border focus:shadow-panel-neon outline-none transition-all"
                    />
                </div>
              </div>
              <input 
            ...
            {/* Manual Inputs Row */}
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-engine-panel-border/20">
                <div>
                    ...
                    <input 
                        ...
                        className="w-full bg-engine-bg border border-engine-panel-border/30 text-white font-mono font-bold rounded-lg px-4 py-3 focus:border-engine-panel-border focus:shadow-panel-neon outline-none transition-all"
                    />
                </div>
                <div>
          ...
          <div className="bg-engine-panel p-6 rounded-2xl border border-engine-panel-border/20 shadow-2xl flex flex-col items-center justify-center text-center relative overflow-hidden">
             ...
             <div className="bg-engine-bg/80 px-6 py-2 rounded-xl border border-engine-panel-border/30 relative z-10 mb-4">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          {/* Chart Card */}
          <div className="bg-engine-panel p-6 rounded-2xl border border-engine-panel-border/20 shadow-2xl flex-1 flex flex-col min-h-[400px]">
             <h3 className="text-xs font-extrabold text-engine-neon uppercase tracking-widest border-b border-engine-panel-border/20 pb-3 mb-6">Compounding Projection Path</h3>
          ...
          {/* Action Plan Grid */}
          <div className="bg-engine-panel p-6 rounded-2xl border border-engine-panel-border/20 shadow-2xl">
             <h3 className="text-xs font-extrabold text-white uppercase tracking-widest border-b border-engine-panel-border/20 pb-3 mb-6 flex items-center gap-2">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                 ...
                 <div className="bg-engine-button/10 border border-engine-button-border/30 rounded-xl p-5 relative overflow-hidden group">
