                      ...
                      {currentUser === post.username || userData?.role === 'admin' ? (
                        <>
                          {currentUser === post.username && (
                            <button onClick={() => startEditPost(post)} className="w-full text-left px-4 py-3 text-sm text-engine-neon hover:bg-engine-button/10 transition-colors font-bold">Edit</button>
                          )}
                ...
                {(() => {
                      ...
                      <div key={comment.id} className="mt-4" style={{ borderLeft: comment.parent_id ? "2px solid rgba(0, 207, 255, 0.2)" : "none", paddingLeft: comment.parent_id ? "1.5rem" : "0" }}>
                        <div className="bg-engine-bg/60 border border-engine-panel-border/10 p-4 rounded-xl text-sm group relative hover:border-engine-panel-border/30 hover:shadow-panel-neon transition-all">
                          ...
                          <div className="flex items-center gap-5 mt-3 text-[11px] text-gray-500">
                            ...
                            <button onClick={() => { setReplyingTo({ commentId: comment.id, username: comment.username }); setReplyContent(""); }} className="hover:text-engine-neon font-bold transition-colors">Reply</button>
                        ...
                        {hasReplies && !isRepliesExpanded && (
                          <button onClick={() => setExpandedReplies(prev => ({...prev, [comment.id]: true}))} className="text-[11px] text-engine-neon/70 hover:text-engine-neon font-bold mt-3 flex items-center gap-2 ml-4 transition-colors"><span className="transform rotate-90">↳</span> View {comment.children.length} {comment.children.length === 1 ? 'reply' : 'replies'}</button>
                        )}
                  ...
                  return (
                    <>
                      ...
                      {commentTree.length > visibleLimit && <button onClick={() => setVisibleLimit(prev => prev + 10)} className="text-xs text-engine-neon/70 hover:text-engine-neon font-bold mt-5 w-full text-left pl-2 transition-colors">View more comments ({commentTree.length - visibleLimit})</button>}
                    </>
                  )
                })()}
            ...
            {showShareModal && createPortal(
              <div className="fixed inset-0 z-[100] flex items-center justify-center bg-engine-bg/90 backdrop-blur-engine p-4" onClick={() => setShowShareModal(false)}>
                <div className="bg-engine-panel border border-engine-panel-border/30 p-8 rounded-2xl shadow-panel-neon max-w-sm w-full relative overflow-hidden" onClick={e => e.stopPropagation()}>
                  ...
                  <div className="flex flex-row flex-wrap justify-center gap-5 mb-8">
                    <button onClick={() => handleShareOption('x')} className="flex flex-col items-center gap-2 group hover:-translate-y-1 transition-transform">
                      <div className="w-12 h-12 bg-engine-bg rounded-full flex items-center justify-center border border-engine-panel-border/30 group-hover:border-white group-hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] transition-all">
                    ...
                    <button onClick={() => handleShareOption('facebook')} className="flex flex-col items-center gap-2 group hover:-translate-y-1 transition-transform">
                      <div className="w-12 h-12 bg-[#1877F2]/10 rounded-full flex items-center justify-center border border-[#1877F2]/30 group-hover:bg-[#1877F2] group-hover:shadow-[0_0_15px_rgba(24,119,242,0.4)] transition-all">
                        <svg viewBox="0 0 24 24" width="22" height="22" className="fill-[#1877F2] group-hover:fill-white transition-colors">
                    ...
                    <button onClick={() => handleShareOption('whatsapp')} className="flex flex-col items-center gap-2 group hover:-translate-y-1 transition-transform">
                      <div className="w-12 h-12 bg-[#25D366]/10 rounded-full flex items-center justify-center border border-[#25D366]/30 group-hover:bg-[#25D366] group-hover:shadow-[0_0_15px_rgba(37,211,102,0.4)] transition-all">
                        <svg viewBox="0 0 24 24" width="24" height="24" className="fill-[#25D366] group-hover:fill-white transition-colors">
                    ...
                    <button onClick={() => handleShareOption('instagram')} className="flex flex-col items-center gap-2 group hover:-translate-y-1 transition-transform">
                      <div className="w-12 h-12 bg-gradient-to-tr from-[#f09433]/20 via-[#e6683c]/20 to-[#bc1888]/20 rounded-full flex items-center justify-center border border-pink-500/30 group-hover:from-[#f09433] group-hover:via-[#e6683c] group-hover:to-[#bc1888] group-hover:shadow-[0_0_15px_rgba(236,72,153,0.4)] transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-pink-500 group-hover:text-white transition-colors">
                    ...
                    <button onClick={() => handleShareOption('copy')} className="flex flex-col items-center gap-2 group hover:-translate-y-1 transition-transform">
                      <div className="w-12 h-12 bg-engine-button/10 rounded-full flex items-center justify-center border border-engine-button-border/30 group-hover:bg-engine-button group-hover:shadow-button-neon transition-all">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-engine-neon group-hover:text-engine-bg transition-colors">
          ...
          <div className="relative z-10 flex items-center gap-6">
            ...
            <div>
              <button
                ...
                className="opacity-100 hover:opacity-100 text-sm mb-2 flex items-center gap-2 font-bold text-white hover:text-engine-neon transition-colors drop-shadow-md"
              >
                ← Back to Communities
              </button>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        className="text-xs text-engine-neon/70 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-engine-button/10 file:text-engine-neon hover:file:bg-engine-button/20 transition-all cursor-pointer"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  {newComm.bgType === "image" ? (
                    <div>
                      ...
                      <input
                        ...
                        className="text-xs text-engine-neon/70 w-full file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-engine-button/10 file:text-engine-neon hover:file:bg-engine-button/20 transition-all cursor-pointer"
                      />
                    </div>
                  ) : (
                    <div>
                      ...
                      {newComm.bgType === "gradient" ? (
                          ...
                          <div className="flex gap-4">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 bg-engine-panel border border-engine-panel-border/20 rounded-lg p-1.5 focus-within:border-engine-panel-border transition-colors">
                                ...
                                />
                                <span className="text-xs text-engine-neon font-mono">
                        ...
                        <div className="flex items-center gap-3 bg-engine-bg/50 border border-engine-panel-border/20 rounded-xl p-2 w-fit">
                          ...
                          />
                          <span className="text-xs font-mono text-engine-neon pr-2">{newComm.bgValue}</span>
                        </div>
                      )}
                    </div>
                  )}
                    ...
                    <div className="animate-fade-in">
                      ...
                      <div className="flex items-center gap-3 bg-engine-bg/50 border border-engine-panel-border/20 rounded-xl p-2 w-fit focus-within:border-engine-panel-border transition-colors">
                        <input
                          ...
                          className="h-6 w-8 bg-transparent border-0 cursor-pointer rounded"
                        />
                        <span className="text-xs text-engine-neon font-mono pr-2">
                          {newComm.hoverColor}
                        </span>
                      </div>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-80 font-medium">by <span className="text-engine-neon">You</span></p>
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-engine-bg/90 backdrop-blur-engine p-4">
          <div className="bg-engine-panel border border-engine-panel-border/30 p-8 rounded-2xl shadow-panel-neon max-w-sm w-full animate-fade-in text-center relative overflow-hidden">
            ...
            <p className="text-gray-400 text-sm mb-8 leading-relaxed">
              ...
              <span className="text-engine-neon font-bold">
