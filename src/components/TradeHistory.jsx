...
const TradeHistory = () => {
  ...
  if (loading) return <div className="flex justify-center py-20"><div className="w-10 h-10 border-4 border-engine-panel-border/20 border-t-[#00cfff] rounded-full animate-spin"></div></div>;
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center bg-engine-panel/80 backdrop-blur-md p-4 rounded-2xl border border-engine-panel-border/20 shadow-panel-neon">
        ...
        <div className="flex gap-3 items-center">
            <select 
                ...
                className="bg-engine-bg border border-engine-panel-border/30 text-white text-xs font-bold uppercase tracking-widest rounded-lg px-4 py-2 outline-none focus:border-engine-panel-border transition-all"
            >
            ...
            {planLevel >= 1 || isAdmin ? (
            <button onClick={handleExportCSV} className="bg-engine-button/10 hover:bg-engine-button text-engine-neon hover:text-engine-bg border border-engine-button-border/50 px-4 py-2 rounded-lg text-xs font-extrabold uppercase tracking-widest flex items-center gap-2 transition-all shadow-button-neon">
            ...
            <button disabled className="bg-engine-bg border border-engine-button-border/30 text-gray-500 px-4 py-2 rounded-lg text-xs font-extrabold uppercase tracking-widest cursor-not-allowed flex items-center gap-2"><Lock className="w-3 h-3" /> EXPORT</button>
            )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-engine-panel rounded-2xl border border-engine-panel-border/20 shadow-2xl p-6 relative overflow-hidden flex flex-col">
        ...
        <div className="lg:col-span-8 space-y-6 flex flex-col">
          <div className="bg-engine-panel rounded-2xl border border-engine-panel-border/20 shadow-2xl p-6 relative flex-1">
            <div className="absolute top-0 right-0 p-4 opacity-50 cursor-pointer hover:opacity-100 transition-opacity">
              <span className="text-gray-400 font-bold tracking-widest">•••</span>
            </div>
      ...
      {/* Recent Trades Table */}
      <div className="bg-engine-panel rounded-2xl border border-engine-panel-border/20 shadow-2xl overflow-hidden relative">
        <div className="p-6 border-b border-engine-panel-border/20 flex justify-between items-center">
